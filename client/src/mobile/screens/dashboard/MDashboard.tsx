...
function SpotlightPill({ icon, label }: { icon: React.ReactElement; label: string }): React.ReactElement {
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-white/[.28] px-[9px] py-[3px] font-geist text-[0.5625rem] font-bold tracking-[.07em] text-white uppercase backdrop-blur-[6px]">
      {icon}
      {label}
    </span>
  )
