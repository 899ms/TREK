...
import { DOCUMENT_PROVIDER_ICONS, SynologyDriveIcon } from '../shared/DocumentProviderIcons'
...
const PROVIDER_ICONS: Record<string, ComponentType<{ size?: number }>> = {
  immich: ImmichIcon,
  // Photos and Drive are the same brand, so they carry the same mark.
  synologyphotos: SynologyDriveIcon,
