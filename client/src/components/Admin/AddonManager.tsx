...
const PROVIDER_ICONS: Record<string, ComponentType<{ size?: number }>> = {
  ...
  // Document providers reuse the Synology mark for the NAS and fall back to a
  // generic lucide icon otherwise, rather than shipping four more brand SVGs
  // for rows that are 14px tall.
  synologydrive: SynologyIcon,
}
