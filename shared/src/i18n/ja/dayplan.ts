...
const dayplan: TranslationStrings = {
  ...
  'dayplan.deleteDay': '日を削除',
  'dayplan.deleteDayTitle': '{day}を削除しますか？',
  'dayplan.deleteDayBody': 'この日は旅行から削除されます。元に戻すことはできません。',
  'dayplan.deleteDayEmpty': 'この日には何も予定されていません。',
  'dayplan.impactPlaces': '予定しているスポット: {count}',
  'dayplan.impactPlacesHint': 'スポット一覧には残ります。',
  'dayplan.impactNotes': 'メモ: {count}',
  'dayplan.impactTexts': '日のタイトルと説明: {count}',
  'dayplan.impactDeletedHint': 'これらも削除されます。',
  'dayplan.impactBookings': '予約: {count}',
  'dayplan.impactStay': '{name}での宿泊',
  'dayplan.deleteDayBookingsHint': '日付なしで予約に残ります。',
