...
const dayplan: TranslationStrings = {
  ...
  'dayplan.deleteDay': 'Ta bort dag',
  'dayplan.deleteDayTitle': 'Ta bort {day}?',
  'dayplan.deleteDayBody': 'Dagen tas bort från resan. Det går inte att ångra.',
  'dayplan.deleteDayEmpty': 'Inget är planerat den här dagen.',
  'dayplan.impactPlaces': 'Planerade platser: {count}',
  'dayplan.impactPlacesHint': 'De ligger kvar i platslistan.',
  'dayplan.impactNotes': 'Anteckningar: {count}',
  'dayplan.impactTexts': 'Dagtitlar och beskrivningar: {count}',
  'dayplan.impactDeletedHint': 'Tas också bort.',
  'dayplan.impactBookings': 'Bokningar: {count}',
  'dayplan.impactStay': 'Boende på {name}',
  'dayplan.deleteDayBookingsHint': 'De ligger kvar under Bokningar, utan dag.',
  ...
  'dayplan.addUndatedDay': 'Utan datum',
