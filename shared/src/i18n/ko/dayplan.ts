...
const dayplan: TranslationStrings = {
  ...
  'dayplan.deleteDay': '날짜 삭제',
  'dayplan.deleteDayTitle': '{day}을(를) 삭제할까요?',
  'dayplan.deleteDayBody': '이 날짜가 여행에서 제거됩니다. 되돌릴 수 없습니다.',
  'dayplan.deleteDayEmpty': '이 날짜에는 계획된 항목이 없습니다.',
  'dayplan.impactPlaces': '계획된 장소: {count}',
  'dayplan.impactPlacesHint': '장소 목록에는 그대로 남습니다.',
  'dayplan.impactNotes': '메모: {count}',
  'dayplan.impactTexts': '날짜 제목과 설명: {count}',
  'dayplan.impactDeletedHint': '함께 삭제됩니다.',
  'dayplan.impactBookings': '예약: {count}',
  'dayplan.impactStay': '{name} 숙박',
  'dayplan.deleteDayBookingsHint': '날짜 없이 예약에 남습니다.',
  'dayplan.deleteDayStayHint': '이 날짜에 체크인 또는 체크아웃하므로 숙박이 취소됩니다.',
  'dayplan.deleteDayStayBookedHint':
    '이 날짜에 체크인 또는 체크아웃하므로 숙박이 예약 “{booking}” 및 해당 지출과 함께 취소됩니다.',
  'dayplan.deleteDayStayBookingHint': '이 날짜에 체크인 또는 체크아웃하므로 숙박이 예약 “{booking}”과 함께 취소됩니다.',
  'dayplan.deleteDayStayPaidHint':
    '이 날짜에 체크인 또는 체크아웃하므로 숙박이 취소되며, 예약 “{booking}”과 해당 지출({amount})도 함께 취소됩니다.',
  'dayplan.deleteDayShift': '이후 날짜: {count}',
  'dayplan.deleteDayShiftHint': '각각 하루씩 앞당겨집니다.',
  'dayplan.deleteDayShiftBookingsHint': '각각 하루씩 앞당겨집니다. 함께 이동하는 예약: {count}',
  'dayplan.deleteDayShrink': '이제 여행이 {date}에 끝납니다',
  'dayplan.deleteDayShrinkHint': '마지막 날짜를 이어받을 날짜 없는 일정이 없습니다.',
  'dayplan.impactStayShorter': '{name} 숙박: 1박 줄어듦',
  'dayplan.deleteDayStayShorterHint': '이 날짜에 걸쳐 있어 체크아웃이 {date}(으)로 바뀝니다.',
  'dayplan.deleteDayStayShorterUndatedHint': '이 날짜에 걸쳐 있어 하루 일찍 끝납니다.',
  'dayplan.deleteDaySpareDated': '{day}의 날짜가 {date}(으)로 지정됩니다',
  'dayplan.deleteDaySpareDatedHint': '날짜가 없는 첫 번째 날이며, 여행의 마지막 날짜를 이어받습니다.',
  'dayplan.deleteDayLast': '여행에는 최소 하루가 필요합니다',
