...
const dayplan: TranslationStrings = {
  ...
  'dayplan.impactNotes': 'Notities: {count}',
  'dayplan.impactTexts': 'Dagtitels en beschrijvingen: {count}',
  'dayplan.impactDeletedHint': 'Worden ook verwijderd.',
  'dayplan.impactBookings': 'Boekingen: {count}',
  'dayplan.impactStay': 'Verblijf in {name}',
  'dayplan.deleteDayBookingsHint': 'Ze blijven onder Boekingen, zonder dag.',
  ...
  'dayplan.deleteDayError': 'Dag verwijderen mislukt',
  'dayplan.addUndatedDay': 'Zonder datum',
  'dayplan.addUndatedDayHint': 'Voegt aan het eind een dag zonder datum toe. De reisdata blijven zoals ze zijn.',
  'dayplan.addDatedDay': '{date} toevoegen',
  'dayplan.addDatedDayHint': 'Verlengt de reis met één dag, tot {date}.',
  'dayplan.tripExtended': 'Dag toegevoegd. De reis eindigt nu op {date}.',
};
