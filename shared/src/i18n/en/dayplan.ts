...
const dayplan: TranslationStrings = {
  ...
  'dayplan.deleteDay': 'Delete day',
  'dayplan.deleteDayTitle': 'Delete {day}?',
  'dayplan.deleteDayBody': 'The day is removed from the trip. This cannot be undone.',
  'dayplan.deleteDayEmpty': 'Nothing is planned on this day.',
  'dayplan.impactPlaces': 'Planned places: {count}',
  'dayplan.impactPlacesHint': 'They stay in the place list.',
  'dayplan.impactNotes': 'Notes: {count}',
  'dayplan.impactTexts': 'Day titles and descriptions: {count}',
  'dayplan.impactDeletedHint': 'Deleted as well.',
  'dayplan.impactBookings': 'Bookings: {count}',
  'dayplan.impactStay': 'Stay at {name}',
  'dayplan.deleteDayBookingsHint': 'They stay under Bookings, without a day.',
  ...
  'dayplan.deleteDayError': 'Failed to delete day',
