...
const dayplan: TranslationStrings = {
  ...
  'dayplan.deleteDayStayBookingHint': '入住或退房在這一天，因此住宿會被取消，同時取消預訂「{booking}」。',
  'dayplan.deleteDayStayPaidHint':
    '入住或退房在這一天，因此住宿會被取消，同時取消預訂「{booking}」及其 {amount} 的費用。',
  ...
  'dayplan.deleteDayStayShorterHint': '這段住宿跨越這一天，現在於 {date} 退房。',
  'dayplan.deleteDayStayShorterUndatedHint': '這段住宿跨越這一天，現在提前一天結束。',
  'dayplan.deleteDaySpareDated': '{day} 取得日期 {date}',
  'dayplan.deleteDaySpareDatedHint': '這是第一個沒有日期的日子，它會使用行程的最後一個日期。',
