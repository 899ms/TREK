...
const dayplan: TranslationStrings = {
  ...
  'dayplan.impactNotes': 'الملاحظات: {count}',
  'dayplan.impactTexts': 'عناوين الأيام وأوصافها: {count}',
  'dayplan.impactDeletedHint': 'تُحذف أيضًا.',
  'dayplan.impactBookings': 'الحجوزات: {count}',
  'dayplan.impactStay': 'الإقامة في {name}',
  'dayplan.deleteDayBookingsHint': 'تبقى ضمن الحجوزات، دون يوم.',
  ...
  'dayplan.tripExtended': 'تمت إضافة اليوم. تنتهي الرحلة الآن في {date}.',
};
